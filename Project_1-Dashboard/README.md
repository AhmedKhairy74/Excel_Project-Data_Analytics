...
The dataset used for this project contains real-world data science job information from 2023. The dataset is included in [Resources folder](0_Resources/Datasets). It includes detailed information on:
